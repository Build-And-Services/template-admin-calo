        ...
        <div class="card">
            <div class="p-6">
                ...
                <div class="flex items-center justify-between mb-6">
                    ...
                    <a href="{{url('admin/artist/create')}}" class="flex rounded-sm overflow-hidden">
                        ...
                        <button class="btn bg-success text-white rounded-none">Add Artist</button>
                    </a>
                </div>
                            ...
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" class="px-4 py-4 text-start text-sm font-medium text-gray-500">Instagram <br>Twitter <br>Tiktok</th>
                                        <th scope="col" class="px-4 py-4 text-start text-sm font-medium text-gray-500">Profile</th>
                                        <th scope="col" class="px-4 py-4 text-start text-sm font-medium text-gray-500">Profession</th>
                                        <th scope="col" class="px-4 py-4 text-center text-sm font-medium text-gray-500">Action</th>
                                    </tr>
                                </thead>
                                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                    <?php $no=1 ;?>
                                    @foreach ($getArtist as $item)
                                        <tr class="bg-gray-50 dark:bg-gray-700/50">
                                            <td class="px-4 py-4 whitespace-nowrap text-sm font-bold text-gray-500 dark:text-gray-200">
                                                {{$no++}}
                                            </td>
                                            ...
                                            <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-200">
                                                <img src="{{asset($item->img)}}" alt="image" class="rounded h-20 w-20">
                                            </td>
                                            ...
                                            <td class="px-4 py-4">
                                                <div class="flex items-center text-center justify-start space-x-3">
                                                    <a href="{{url('admin/artist/'. $item->id .'/edit')}}" class="border border-info/20 btn bg-info/20 text-info hover:bg-info hover:text-white"><i class="mdi mdi-pencil text-base"></i> </a>
                                                    <form action="{{url('admin/artist',$item->id)}}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
