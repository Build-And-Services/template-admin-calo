        ...
        <div class="card">
            <div class="p-6">
                ...
                <div class="flex items-center justify-between mb-6">
                    ...
                    <a href="{{url('admin/payment-method/create')}}" class="flex rounded-sm overflow-hidden">
                        ...
                        <button class="btn bg-success text-white rounded-none">Add Payment Method</button>
                    </a>
                </div>
                            ...
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" class="px-4 py-4 text-start text-sm font-medium text-gray-500">Platform</th>
                                        <th scope="col" class="px-4 py-4 text-start text-sm font-medium text-gray-500">Type</th>
                                        <th scope="col" class="px-4 py-4 text-start text-sm font-medium text-gray-500">Image</th>
                                ...
                                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                    ...
                                    @foreach ($getPaymentMethods as $item)
                                        <tr class="bg-gray-50 dark:bg-gray-700/50">
                                            ...
                                            <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-200">{{$item->platform}}</td>
                                            <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-200">{{$item->type}}</td>
