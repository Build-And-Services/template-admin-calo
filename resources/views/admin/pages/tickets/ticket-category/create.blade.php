        ...
        <div class="card">
            <div class="p-6">
                <div class="flex items-center justify-between mb-6">
                    <h3 class="card-title">Create Ticket Category</h3>
                ...
                <form action="{{ url('admin/ticket-category') }}" method="POST" enctype="multipart/form-data">
                <div class="grid lg:grid-cols-2 gap-5">

                        @csrf
                        <div>
                            <label for="name" class="block mb-2">Ticket Category Name</label>
