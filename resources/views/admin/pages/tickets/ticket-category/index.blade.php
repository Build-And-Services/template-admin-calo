        ...
        <div class="card">
            <div class="p-6">
                ...
                <div class="flex items-center justify-between mb-6">
                    ...
                    <a href="{{url('admin/ticket-category/create')}}" class="flex rounded-sm overflow-hidden">
                        ...
                        <button class="btn bg-success text-white rounded-none">Add Ticket Category</button>
                    </a>
                </div>
                                        ...
                                        <tr class="bg-gray-50 dark:bg-gray-700/50">
                                            ...
                                            <td class="px-4 py-4">
                                                <div class="flex items-center text-center justify-start space-x-3">
                                                    <a href="{{url('admin/ticket-category/'. $item->id .'/edit')}}" class="border border-info/20 btn bg-info/20 text-info hover:bg-info hover:text-white"><i class="mdi mdi-pencil text-base"></i> </a>
                                                    <form action="{{url('admin/ticket-category',$item->id)}}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
