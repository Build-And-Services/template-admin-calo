        ...
        <div class="card">
            <div class="p-6">
                ...
                <div class="grid lg:grid-cols-2 gap-5">
                        ...
                        <div>
                            <label for="price" class="block mb-2">Ticket Price</label>
                            <input type="number" name="price" class="form-input" id="price" required>
                        </div>
                        <div>
                            <label for="stock" class="block mb-2">Ticket Stock</label>
                            <input type="number" name="stock" class="form-input" id="stock" required>
                        </div>
                        <div>
                            ...
                            <select class="form-select" name="ticket_category_id" id="ticket_category_id" required>
                                ...
                                @foreach ($getTicketCategories as $item)
                        ...
                        <div>
                            <label class="block text-gray-600 mb-2" for="ticket_category_id">Event</label>
