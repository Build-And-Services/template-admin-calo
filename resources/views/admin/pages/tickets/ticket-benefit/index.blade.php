        ...
        <div class="card">
            <div class="p-6">
                ...
                <div class="flex items-center justify-between mb-6">
                    ...
                    <a href="{{url('admin/ticket-benefit/create')}}" class="flex rounded-sm overflow-hidden">
                        ...
                        <button class="btn bg-success text-white rounded-none">Add Ticket Benefit</button>
                    </a>
                </div>
                            ...
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" class="px-4 py-4 text-start text-sm font-medium text-gray-500">Benefits</th>
                                        <th scope="col" class="px-4 py-4 text-start text-sm font-medium text-gray-500">Action</th>
                                    </tr>
                                </thead>
                                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                    <?php $no=1; ?>
                                    @foreach ($getTicketBenefit as $item)
                                        <tr class="bg-gray-50 dark:bg-gray-700/50">
                                            ...
                                            <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-200">{{$item->benefits}}</td>
                                            <td class="px-4 py-4">
                                                <div class="flex items-center text-center justify-start space-x-3">
                                                    <a href="{{url('admin/ticket-benefit/'. $item->id .'/edit')}}" class="border border-info/20 btn bg-info/20 text-info hover:bg-info hover:text-white"><i class="mdi mdi-pencil text-base"></i> </a>
                                                    <form action="{{url('admin/ticket-benefit',$item->id)}}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
