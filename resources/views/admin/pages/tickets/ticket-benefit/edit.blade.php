        ...
        <div class="card">
            <div class="p-6">
                <div class="flex items-center justify-between mb-6">
                    <h3 class="card-title">Edit Ticket Benefit</h3>
                ...
                <form action="{{ url('admin/ticket-benefit', $getTicketBenefit->id) }}" method="POST" enctype="multipart/form-data">
                    <div class="grid lg:grid-cols-2 gap-5">
                        ...
                        <div>
                            ...
                            <input type="text" name="benefits" class="form-input" value="{{$getTicketBenefit->benefits}}" id="benefits">
                            @error('benefits')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
