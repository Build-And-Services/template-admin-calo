    ...
    <div class="flex items-center px-6 gap-3">
        ...
        <a href="{{url('/admin/dashboard')}}" class="logo-box">
            ...
            <div class="logo-light">
                <img src="{{asset('assets-admin/images/logo-light.png" class="logo-lg')}}" alt="Light logo">
                ...
                <div class="p-4 h-80" data-simplebar>
                    ...
                    <a href="javascript:void(0);" class="block mb-4">
                        <div class="card-body">
                            <div class="flex items-center">
                                <div class="flex-shrink-0">
                                    <img src="{{asset('assets-admin/images/users/avatar-2.jpg')}}" class="rounded-full h-9 w-9" alt="">
                                </div>
                                <div class="flex-grow truncate ms-2">
                    ...
                    <a href="javascript:void(0);" class="block">
                        <div class="card-body">
                            <div class="flex items-center">
                                <div class="flex-shrink-0">
                                    <img src="{{asset('assets-admin/images/users/avatar-4.jpg')}}" class="rounded-full h-9 w-9" alt="">
                                </div>
                                <div class="flex-grow truncate ms-2">
        ...
        <div class="relative">
            <button data-fc-type="dropdown" data-fc-placement="bottom-end" type="button" class="nav-link flex items-center">
                <img src="{{asset('assets-admin/images/profile-admin.jpg')}}" alt="user-image" class="rounded-full h-8 w-8">
            ...
            <div class="fc-dropdown fc-dropdown-open:opacity-100 hidden opacity-0 w-44 z-50 transition-[margin,opacity] duration-300 bg-white shadow-lg border rounded py-2 border-gray-200 dark:border-gray-700 dark:bg-gray-800">
                <h6 class="py-2 px-5">Welcome {{Auth::user()->name}} !</h6>
                ...
                <form action="{{url('logout')}}" method="POST">
                    @csrf
                    <button type="submit" class="flex w-full text-center items-center py-2 px-3 rounded-md text-sm text-gray-800 hover:bg-primary dark:text-gray-400 hover:text-white dark:hover:text-white">
